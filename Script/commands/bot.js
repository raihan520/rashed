...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "help") || (event.body.toLowerCase() == "help")) {
     return api.sendMessage("আমার বস রায়হান কে বলো সাহায্য করবে", threadID);
   };
  
   if ((event.body.toLowerCase() == "Nusrat") || (event.body.toLowerCase() == "@Nusrat Jahan Shimu")) {
     return api.sendMessage("এই বেডির মন অনেক বড় ডেকে লাভ নাই--!!🫵🤣", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Raihan") || (event.body.toLowerCase() == "রায়হান") || (event.body.toLowerCase() == "@ﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻ ﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻ ﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻﷻ") || (event.body.toLowerCase() == "উল্লাস")) {
     return api.sendMessage("আমার বস এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "Admin") || (event.body.toLowerCase() == "Ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Rijuan Ahmed Raihan ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Raihan 𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61586269511910 তার সাথে যোগাযোগ করবেন WhatsApp :- +97123767236", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss k") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: রিজোয়ান আহমেদ রায়হান--!! ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রায়হান আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন🌺🥀💝", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("রিজোয়ান আহমেদ রায়হান❤️ তাকে সবাই রায়হান নামে  চিনে🤙", threadID);
   };

   if ((event.body.toLowerCase() == "@everyone") || (event.body.toLowerCase() == "Ai")) {
     return api.sendMessage("তোর এতো চুলকানি কেনো হুম🤭🫵", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@Mst Lija Khatun") || (event.body.toLowerCase() == "@পেতনি")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রায়হান এর বউ এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "লিজা") || (event.body.toLowerCase() == "Lija")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রায়হান এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "@Nil Pori") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage(" আমাদের মহিলা এডমিন; এই বেডির জামাই আছে কেউ কিছু বলো না😘🌺", threadID);
   };

  if ((event.body.toLowerCase() == "নুসরাত") || (event.body.toLowerCase() == "Nusrat")) {
     return api.sendMessage(" ওর পিছনে ঘুরে লাভ নাই: ও আমার বস রায়হান এর বান্ধবী😍🥰", threadID);
   };

  if ((event.body.toLowerCase() == "@বাহার ভাই") || (event.body.toLowerCase() == "বাহার ভই")) {
     return api.sendMessage("আমাদের সম্মানিত C.E.O ওনার সুন্দর কিউট একটা বউ আছে--!!🤭😁", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>RASHED RAIHAN CHAT BOT", threadID);
   };

   if ((event.body.toLowerCase() == "BOT ER BACCHA") || (event.body.toLowerCase() == "Bot ar baccha")) {
   ...
   if ((event.body.toLowerCase() == "@Saiba Akter") || (event.body.toLowerCase() == "Saiba")) {
     return api.sendMessage("️আমার বস রায়হান এর জান😍 ডিস্টার্ব কইরো না কেউ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "mon kharap") || (event.body.toLowerCase() == "tomar ki mon kharap")) {
   ...
   if ((event.body.toLowerCase() == "tomi ki amake valobasho") || (event.body.toLowerCase() == "tmi ki amake valo basho")) {
